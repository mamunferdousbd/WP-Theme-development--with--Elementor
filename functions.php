...
function picchi_scripts() {
	// Fontawesome
	wp_enqueue_style('fontawesomecss',get_template_directory_uri().'/assets/css/fontawesome.min.css' , array(), '5.15.4','all');
	// Google fonts 
	...
	wp_enqueue_style('picchi_maincss',get_template_directory_uri().'/assets/css/style.css' , array(),'1.0.1' , 'all');
	wp_enqueue_style( 'picchi-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'picchi-style', 'rtl', 'replace' );

	// JS file Enqueue
	wp_enqueue_script('picchi_bootstrapjs', get_template_directory_uri().'/assets/js/bootstrap.min.js', array('jquery'), '5.1.3',true);
	wp_enqueue_script('picchi_popperjs', get_template_directory_uri().'/assets/js/popper.min.js', array('jquery'), '5.1.3',true);
